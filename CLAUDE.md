...
| **Chapter 27: Main Menu GUI Fix** | Phases A-B COMPLETE (6/15 tasks, 40%; commits: `58995dd`/`152890b`/`1bacfc5`/`cbb2de9`) -- chrome asset pipeline + ChromeProvider/FileSystem wiring done; Phases C-E PLANNING |
