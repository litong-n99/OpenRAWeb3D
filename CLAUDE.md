...
| **Chapter 27: Main Menu GUI Fix** | Phases A-C COMPLETE (9/15 tasks, 60%; commits: `58995dd`/`152890b`/`1bacfc5`/`cbb2de9`/`8ea60b1`/`e0a40a4`/`3748c28`) -- chrome asset pipeline + ChromeProvider/FileSystem wiring + Widget-based main menu activation done; Phases D-E PLANNING |
