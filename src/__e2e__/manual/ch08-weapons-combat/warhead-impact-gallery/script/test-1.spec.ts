...
// NOTE: This spec is designed to run from tests-e2e/ (not src/__e2e__/manual/).
// When run from tests-e2e/, 4 levels up reaches the project root.
// When moved back to src/__e2e__/manual/, adjust the evidence path accordingly.
