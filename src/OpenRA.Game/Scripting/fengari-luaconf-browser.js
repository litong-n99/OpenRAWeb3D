...
// BUGFIX ch20: process.env is not available in browser.
// Use empty conf — fengari defaults are sufficient for web runtime.
var _fengari_conf = {};
try { _fengari_conf = process.env.FENGARICONF ? JSON.parse(process.env.FENGARICONF) : {}; } catch(_e) {}
const conf = _fengari_conf;
...
} // BUGFIX ch20: always use browser path (no require('os') — Node.js only)
