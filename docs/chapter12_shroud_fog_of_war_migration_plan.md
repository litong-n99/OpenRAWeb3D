...
- [ ] **TODO-12.A.4** `src/OpenRA.Mods.Common/Traits/Cloak.ts` (374 lines C#) -- Stealth/cloak system:
...
- [ ] **TODO-12.A.5** `src/OpenRA.Mods.Common/Traits/AffectsShroud.ts` (174 lines C#) -- Abstract base for shroud-affecting traits:
  - `AffectsShroudInfo`:
