...
| **Chapter 24 planned files (Animation & 3D Visual Effects)** | 10 (4 phases A-D, 5 modified + 2 test), **Phase A COMPLETE (4/10, commits `a60f716`/`0616092`, 94 tests, ~337 impl + ~744 test lines, APPROVED)**. Plan: [chapter24_animation_effects_plan.md](docs/chapter24_animation_effects_plan.md) |
| **Chapter 25 planned files (Shroud & Fog of War 3D)** | TBD (planning phase, design doc created). Plan: [chapter25_shroud_3d_plan.md](docs/chapter25_shroud_3d_plan.md) |
