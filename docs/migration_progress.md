...
| **Chapter 23 planned files (MIX File Runtime Parsing)** | TBD (planning phase, design doc created). Plan: [chapter23_mix_runtime_plan.md](docs/chapter23_mix_runtime_plan.md) |
| **Chapter 24 planned files (Animation & 3D Visual Effects)** | TBD (planning phase, design doc created). Plan: [chapter24_animation_effects_plan.md](docs/chapter24_animation_effects_plan.md) |
