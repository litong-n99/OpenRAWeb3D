...
| **Chapter 12 planned files (Shroud & Fog of War)** | ~15 (1 Phase A planned), 0/15 migrated. Plan: [docs/chapter12_shroud_fog_of_war_migration_plan.md](docs/chapter12_shroud_fog_of_war_migration_plan.md) |
...
**Next Steps**: Implement `Shroud.ts` core visibility tracker, then parallel tracks for visual renderer, frozen actors, visibility traits, and stealth system.
