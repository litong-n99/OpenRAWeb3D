...
| **Chapter 25 planned files (Shroud & Fog of War 3D)** | 7 (3 phases A-C, 2 modified + 2 test + 3 e2e), **Phases A+B COMPLETE (4/7, 57%)**. Phase A commits: `fc125a9`, follow-up. Phase B commits: `50a6676` (impl), `a5f8de2` (review fixes). Plan: [chapter25_shroud_3d_plan.md](docs/chapter25_shroud_3d_plan.md) |
