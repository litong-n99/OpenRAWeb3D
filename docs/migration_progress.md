...
| **Chapter 25 planned files (Shroud & Fog of War 3D)** | 7 (3 phases A-C, 2 modified + 2 test + 3 e2e), **Phase A COMPLETE (2/7, 29%)**. Phase A commits: `fc125a9`, follow-up review fixes + e2e. Plan: [chapter25_shroud_3d_plan.md](docs/chapter25_shroud_3d_plan.md) |
